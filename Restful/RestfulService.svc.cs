    ...
    { 
        ...
        public CCS_Chart_Info_Reply PostDeviceDetail(CCS_Chart_Info_Req info)
        {
            ...
            try
            {
                ...
                DateTime EndTime;
                //------ Get ItemCount 
                if (Int32.TryParse(info.get_count, out _getcount))
                {
                    // if 
                }
                else
                ...
                try
                {
                    StartTime = DateTime.ParseExact(info.start_time, "yyyyMMddHHmmss", System.Globalization.CultureInfo.CurrentCulture);
                    EndTime = DateTime.ParseExact(info.end_time, "yyyyMMddHHmmss", System.Globalization.CultureInfo.CurrentCulture);
                }
                catch (Exception ex)
                {
                ...
                using (IOT_DbContext db = new IOT_DbContext(providername, connection_string))
                {
                    ...
                    else
                    {
                        ...
                        {
                            case 1:
                                var EDC001 = db.IOT_DEVICE_EDC_001.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 2:
                                var EDC002 = db.IOT_DEVICE_EDC_002.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 3:
                                var EDC003 = db.IOT_DEVICE_EDC_003.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 4:
                                var EDC004 = db.IOT_DEVICE_EDC_004.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 5:
                                var EDC005 = db.IOT_DEVICE_EDC_005.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 6:
                                var EDC006 = db.IOT_DEVICE_EDC_006.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 7:
                                var EDC007 = db.IOT_DEVICE_EDC_007.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 8:
                                var EDC008 = db.IOT_DEVICE_EDC_008.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 9:
                                var EDC009 = db.IOT_DEVICE_EDC_009.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 10:
                                var EDC010 = db.IOT_DEVICE_EDC_010.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 11:
                                var EDC011 = db.IOT_DEVICE_EDC_011.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 12:
                                var EDC012 = db.IOT_DEVICE_EDC_012.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 13:
                                var EDC013 = db.IOT_DEVICE_EDC_013.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 14:
                                var EDC014 = db.IOT_DEVICE_EDC_014.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 15:
                                var EDC015 = db.IOT_DEVICE_EDC_015.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 16:
                                var EDC016 = db.IOT_DEVICE_EDC_016.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 17:
                                var EDC017 = db.IOT_DEVICE_EDC_017.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 18:
                                var EDC018 = db.IOT_DEVICE_EDC_018.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 19:
                                var EDC019 = db.IOT_DEVICE_EDC_019.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 20:
                                var EDC020 = db.IOT_DEVICE_EDC_020.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 21:
                                var EDC021 = db.IOT_DEVICE_EDC_021.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 22:
                                var EDC022 = db.IOT_DEVICE_EDC_022.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 23:
                                var EDC023 = db.IOT_DEVICE_EDC_023.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 24:
                                var EDC024 = db.IOT_DEVICE_EDC_024.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 25:
                                var EDC025 = db.IOT_DEVICE_EDC_025.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 26:
                                var EDC026 = db.IOT_DEVICE_EDC_026.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 27:
                                var EDC027 = db.IOT_DEVICE_EDC_027.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 28:
                                var EDC028 = db.IOT_DEVICE_EDC_028.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 29:
                                var EDC029 = db.IOT_DEVICE_EDC_029.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 30:
                                var EDC030 = db.IOT_DEVICE_EDC_030.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 31:
                                var EDC031 = db.IOT_DEVICE_EDC_031.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 32:
                                var EDC032 = db.IOT_DEVICE_EDC_032.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 33:
                                var EDC033 = db.IOT_DEVICE_EDC_033.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 34:
                                var EDC034 = db.IOT_DEVICE_EDC_034.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 35:
                                var EDC035 = db.IOT_DEVICE_EDC_035.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 36:
                                var EDC036 = db.IOT_DEVICE_EDC_036.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 37:
                                var EDC037 = db.IOT_DEVICE_EDC_037.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 38:
                                var EDC038 = db.IOT_DEVICE_EDC_038.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 39:
                                var EDC039 = db.IOT_DEVICE_EDC_039.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 40:
                                var EDC040 = db.IOT_DEVICE_EDC_040.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 41:
                                var EDC041 = db.IOT_DEVICE_EDC_041.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 42:
                                var EDC042 = db.IOT_DEVICE_EDC_042.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 43:
                                var EDC043 = db.IOT_DEVICE_EDC_043.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 44:
                                var EDC044 = db.IOT_DEVICE_EDC_044.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 45:
                                var EDC045 = db.IOT_DEVICE_EDC_045.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 46:
                                var EDC046 = db.IOT_DEVICE_EDC_046.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 47:
                                var EDC047 = db.IOT_DEVICE_EDC_047.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 48:
                                var EDC048 = db.IOT_DEVICE_EDC_048.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 49:
                                var EDC049 = db.IOT_DEVICE_EDC_049.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 50:
                                var EDC050 = db.IOT_DEVICE_EDC_050.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 51:
                                var EDC051 = db.IOT_DEVICE_EDC_051.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 52:
                                var EDC052 = db.IOT_DEVICE_EDC_052.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 53:
                                var EDC053 = db.IOT_DEVICE_EDC_053.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 54:
                                var EDC054 = db.IOT_DEVICE_EDC_054.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 55:
                                var EDC055 = db.IOT_DEVICE_EDC_055.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 56:
                                var EDC056 = db.IOT_DEVICE_EDC_056.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 57:
                                var EDC057 = db.IOT_DEVICE_EDC_057.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 58:
                                var EDC058 = db.IOT_DEVICE_EDC_058.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 59:
                                var EDC059 = db.IOT_DEVICE_EDC_059.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 60:
                                var EDC060 = db.IOT_DEVICE_EDC_060.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 61:
                                var EDC061 = db.IOT_DEVICE_EDC_061.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 62:
                                var EDC062 = db.IOT_DEVICE_EDC_062.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 63:
                                var EDC063 = db.IOT_DEVICE_EDC_063.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 64:
                                var EDC064 = db.IOT_DEVICE_EDC_064.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 65:
                                var EDC065 = db.IOT_DEVICE_EDC_065.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 66:
                                var EDC066 = db.IOT_DEVICE_EDC_066.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 67:
                                var EDC067 = db.IOT_DEVICE_EDC_067.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 68:
                                var EDC068 = db.IOT_DEVICE_EDC_068.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 69:
                                var EDC069 = db.IOT_DEVICE_EDC_069.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 70:
                                var EDC070 = db.IOT_DEVICE_EDC_070.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 71:
                                var EDC071 = db.IOT_DEVICE_EDC_071.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 72:
                                var EDC072 = db.IOT_DEVICE_EDC_072.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 73:
                                var EDC073 = db.IOT_DEVICE_EDC_073.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 74:
                                var EDC074 = db.IOT_DEVICE_EDC_074.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 75:
                                var EDC075 = db.IOT_DEVICE_EDC_075.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 76:
                                var EDC076 = db.IOT_DEVICE_EDC_076.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 77:
                                var EDC077 = db.IOT_DEVICE_EDC_077.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 78:
                                var EDC078 = db.IOT_DEVICE_EDC_078.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 79:
                                var EDC079 = db.IOT_DEVICE_EDC_079.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 80:
                                var EDC080 = db.IOT_DEVICE_EDC_080.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 81:
                                var EDC081 = db.IOT_DEVICE_EDC_081.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 82:
                                var EDC082 = db.IOT_DEVICE_EDC_082.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 83:
                                var EDC083 = db.IOT_DEVICE_EDC_083.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 84:
                                var EDC084 = db.IOT_DEVICE_EDC_084.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 85:
                                var EDC085 = db.IOT_DEVICE_EDC_085.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 86:
                                var EDC086 = db.IOT_DEVICE_EDC_086.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 87:
                                var EDC087 = db.IOT_DEVICE_EDC_087.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 88:
                                var EDC088 = db.IOT_DEVICE_EDC_088.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 89:
                                var EDC089 = db.IOT_DEVICE_EDC_089.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 90:
                                var EDC090 = db.IOT_DEVICE_EDC_090.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 91:
                                var EDC091 = db.IOT_DEVICE_EDC_091.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 92:
                                var EDC092 = db.IOT_DEVICE_EDC_092.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 93:
                                var EDC093 = db.IOT_DEVICE_EDC_093.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 94:
                                var EDC094 = db.IOT_DEVICE_EDC_094.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 95:
                                var EDC095 = db.IOT_DEVICE_EDC_095.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 96:
                                var EDC096 = db.IOT_DEVICE_EDC_096.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 97:
                                var EDC097 = db.IOT_DEVICE_EDC_097.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 98:
                                var EDC098 = db.IOT_DEVICE_EDC_098.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 99:
                                var EDC099 = db.IOT_DEVICE_EDC_099.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 100:
                                var EDC100 = db.IOT_DEVICE_EDC_100.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 101:
                                var EDC101 = db.IOT_DEVICE_EDC_101.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 102:
                                var EDC102 = db.IOT_DEVICE_EDC_102.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 103:
                                var EDC103 = db.IOT_DEVICE_EDC_103.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 104:
                                var EDC104 = db.IOT_DEVICE_EDC_104.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 105:
                                var EDC105 = db.IOT_DEVICE_EDC_105.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 106:
                                var EDC106 = db.IOT_DEVICE_EDC_106.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 107:
                                var EDC107 = db.IOT_DEVICE_EDC_107.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 108:
                                var EDC108 = db.IOT_DEVICE_EDC_108.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 109:
                                var EDC109 = db.IOT_DEVICE_EDC_109.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 110:
                                var EDC110 = db.IOT_DEVICE_EDC_110.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 111:
                                var EDC111 = db.IOT_DEVICE_EDC_111.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 112:
                                var EDC112 = db.IOT_DEVICE_EDC_112.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 113:
                                var EDC113 = db.IOT_DEVICE_EDC_113.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 114:
                                var EDC114 = db.IOT_DEVICE_EDC_114.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 115:
                                var EDC115 = db.IOT_DEVICE_EDC_115.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 116:
                                var EDC116 = db.IOT_DEVICE_EDC_116.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 117:
                                var EDC117 = db.IOT_DEVICE_EDC_117.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 118:
                                var EDC118 = db.IOT_DEVICE_EDC_118.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 119:
                                var EDC119 = db.IOT_DEVICE_EDC_119.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 120:
                                var EDC120 = db.IOT_DEVICE_EDC_120.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 121:
                                var EDC121 = db.IOT_DEVICE_EDC_121.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 122:
                                var EDC122 = db.IOT_DEVICE_EDC_122.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 123:
                                var EDC123 = db.IOT_DEVICE_EDC_123.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 124:
                                var EDC124 = db.IOT_DEVICE_EDC_124.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 125:
                                var EDC125 = db.IOT_DEVICE_EDC_125.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 126:
                                var EDC126 = db.IOT_DEVICE_EDC_126.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 127:
                                var EDC127 = db.IOT_DEVICE_EDC_127.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
                            ...
                            case 128:
                                var EDC128 = db.IOT_DEVICE_EDC_128.AsQueryable().Where(o => o.device_id.Equals(info.device_id) && o.clm_date_time >= StartTime && o.clm_date_time <= EndTime).OrderBy(p => p.clm_date_time).Take(_getcount).ToList();
